...
class target_scores:
	...
	def get_genetic_score(self):
		col_genetic = ['Target_id', 'gwas_count','gwas_sig', 'OT_MAX_VAL_genetic_association', 'OT_NUM_MAX_genetic_association','OT_TOP10_avg_score']
		...
		self.score_components = self.score_components.merge(genetic_df[['Target_id', 'gen_AScore', 'gen_GScore','gen_GQualScore','gen_AQualScore']],
		                                                    on='Target_id', how='left')
...
def get_descriptors_list(target_id, targetdb=None):
	...
	if OT_diseases.empty:
		...
		OT_top10_qual = OT_top10_qual['overall_score'].reset_index().groupby('target_id')['overall_score'].mean().reset_index().rename(columns={'target_id': 'Target_id', 'overall_score': 'OT_TOP10_avg_score'})
	...
	col_order = ["Target_id", "OT_number_of_associations", "OT_number_of_disease_areas", "OT_list_max_disease_area",
	             "OT_max_association_diseaseArea_score", "OT_list_max_diseases", "OT_TOP10_diseases",'OT_TOP10_avg_score',
